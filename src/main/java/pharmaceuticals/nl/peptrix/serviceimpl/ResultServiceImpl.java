...
public class ResultServiceImpl implements ResultService {
	...
	public Object[][] getdata(int offset, int limit, String filtertext) {
		...
		strquery = "select " + "rs.File, " /* 1 */ + "sa.sampleid, " /* 2 */
				+ "sa.Sample_code, " /* 3 */ + "sa.name , " /* 4 */
				+ "gr.Group_id, " /* 5 */ + "gr.Group_code, " /* 6 */
				+ "gr.Name, " /* 7 */
				+ "resultid, " /* 8 */ + "Offset_LC_MS " /* 9 */
	...
	public Object[][] selectresultrecords(String experimentid, String filtertype) {
		strquery = "select " + "rs.File, " /* 1 */ + "sa.sampleid, " /* 2 */
				...
				+ "gr.Group_id, " /* 5 */ + "gr.Group_code, " /* 6 */
				+ "gr.Name, " /* 7 */
				+ "resultid " /* 8 */ + "from result rs " + "inner join sample sa on rs.sampleid = sa.sampleid "
	...
	// public void insertresultrecordbatch(String existingexperimentid, float
	// filegrootte_kbytes, String filename, String type) {
	// strquery = "INSERT INTO Result(Experimentid, Sampleid, Date, Time, Size_KB,
	// File, Type,Year) "
	// + "VALUES (" + existingexperimentid + ",null,'" +
	// cc.actualtime.getdatestring() + "','"

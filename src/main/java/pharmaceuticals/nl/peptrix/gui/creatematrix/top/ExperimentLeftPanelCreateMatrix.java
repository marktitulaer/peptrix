...
public class ExperimentLeftPanelCreateMatrix {
	...
	public ExperimentLeftPanelCreateMatrix(Controller cc) {
		...
		cc.experimentid2 = new TextField(20);
		cc.experimentid2.addTextListener(cc);
		cc.experimentid2.setEnabled(false);
		cc.experimentid2.setBackground(cc.colorgrey);
		constraintsexperiment.gridx = 2;
		constraintsexperiment.gridy = 1;
		constraintsexperiment.gridwidth = 1;
		constraintsexperiment.gridheight = 1;
		gridbagexperiment.setConstraints(cc.experimentid2, constraintsexperiment);
		panelexperimentleft.add(cc.experimentid2);

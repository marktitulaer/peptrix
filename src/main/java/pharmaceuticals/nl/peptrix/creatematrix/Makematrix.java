		...
		if (odata != null) {
			...
			for (int i = 0; i < odata.length; i++) {
				...
				if (bytesfile != null) {
					...
					// for (int j = 0; j < doublearraycombinedpeaks[0].length; j++) {
					// if ((j > 3027) && (j < 3031)) {
					// System.out.println(" j " + j + " referencemass " +
					// doublearraycombinedpeaks[0][j]
					// + " reference_retentiontime " + doublearraycombinedpeaks[1][j]
					// + " reference_minretentiontime " + doublearraycombinedpeaks[2][j]
					// + " reference_maxretentiontime " + doublearraycombinedpeaks[3][j]);
					// }
					// }

					// System.out.println("Makematrix extra_retention_time_and_ms2_sequencing_data "

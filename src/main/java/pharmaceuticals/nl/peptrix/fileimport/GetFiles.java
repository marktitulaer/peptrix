	...
	public void getFiles() {
		...
		if (fileNamefileChooser != null) {
			...
			if (cc.isnewexperiment) {
				...
				// cc.inputexperimentidfilechooser =
				// experimentidnew.newexperimentid();
